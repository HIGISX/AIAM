...
def train_epoch(model, optimizer, baseline, lr_scheduler, epoch, val_dataset, problem, tb_logger, opts):
    ...
    training_dataset = baseline.wrap_dataset(problem.make_dataset(n_users=opts.n_users, n_facilities=opts.n_facilities,
                                                                  num_samples=opts.epoch_size, filename=None,

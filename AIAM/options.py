...
def get_options(args=None):
    ...
    # overall settings
    parser.add_argument('--problem', default='pMedian', choices=['pMedian', 'pdtspl'],
                        help="The targeted problem to solve, default 'pMedian'")
    parser.add_argument('--n_users', type=int, default=2159, help="The number of users in the targeted problem")
    parser.add_argument('--n_facilities', type=int, default=80, help="The number of facilities in the targeted problem")
    parser.add_argument('--p', type=int, default=15, help="The number of medians in the targeted problem")
    ...
    parser.add_argument('--T_train', type=int, default=100, help='number of itrations for training')
    ...
    parser.add_argument('--T_max', type=int, default=3000, help='number of steps for inference')
    ...
    parser.add_argument('--val_batch_size', type=int, default=2000,
                        help='Number of instances per batch for validation/inference')
    # parser.add_argument('--val_dataset', type=str, default="./data/PM/Test100_50_15.pkl", help='dataset file path')
    parser.add_argument('--val_dataset', type=str, default="./Test/PM/PM15.pkl", help='dataset file path')
    ...
    assert opts.val_m <= opts.n_users // 2

...
def validate(rank, problem, agent, val_dataset, tb_logger, distributed=False, _id=None):
    ...
    val_dataset = problem.make_dataset(filename=val_dataset, n_users=opts.n_users, n_facilities=opts.n_facilities,
                                       p=opts.p, num_samples=opts.val_size)
    print(val_dataset)
    # val_dataset = problem.make_dataset(n_users=opts.n_users, n_facilities=opts.n_facilities, p=opts.p,
